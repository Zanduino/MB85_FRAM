...
Example program for reading and writing to one or more Fujitsu SRAM memory devices on the I2C microLAN. FRAM memory
is static RAM which offers many Read/Write cycles and the description of the MB85 family is found at
http://www.fujitsu.com/global/products/devices/semiconductor/memory/fram/ and the corresponding datasheets are at
